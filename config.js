...
// Auth information
global.pairNumber = "254797992027";                         // Add your paining number with country code example "916297175943"; 
...
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["254797992027", "254797633626"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["916297175943"];
global.OwnerName = process.env.OWNER_NAME || "FAHEEM";
global.BotName = process.env.BOT_NAME || "A17BOT";
global.packname = process.env.PACK_NAME || "A17 Bot";
global.author = "By: FAHEEM";
